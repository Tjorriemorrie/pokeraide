    ...
    def do(self, action):
        ...
        if action[0] == 'c':
            ...
            # if no balance left, then it is an allin
                ...
                self.create_hand_strength(p, d, 1)
...
class PE(PokerEval):
    ...
    def showdown_equities_2(cls, engine, seats, hand_ranges, seats_len):
        ...
        equities_weighed = {s: 0 for s in seats}
        for s in seats:
            ...
            for i, pocket_equity in enumerate(player_equities_ranked):
                ...
                equities_weighed[s] += player_hand_equity
        ...
        total_equities = sum(e for e in equities_weighed.values())
        equities = {s: e / total_equities for s, e in equities_weighed.items()}

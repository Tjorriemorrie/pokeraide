...
class Engine:
    ...
    def do(self, action):
        ...
        if action[0] == 'f':
            d['status'] = 'fold'
            d[self.phase] += ['f'.upper() if faced_aggro else 'f']
            d['hand'] = ['  ', '  ']
        ...
        if action[0] in ['b', 'r']:
            ...
            if int(action[1]) >= p['balance'] - d['contrib']:
                ...
                d[self.phase] += [action[0].upper() if faced_aggro else action[0]]
        ...
        if action[0] == 'labels':
            ...
            d[self.phase] += ['labels'.upper() if faced_aggro else 'labels']
            d['status'] = 'allin'
            d['contrib'] = p['balance']
